...
function getBuyerClientPageActions(decorators = [], preSetUp?: () => void, postSetUp?: () => void) {
...
getBuyerClientPageActions.id = 'onBuyerClientPage';

export { getBuyerClientPageActions }
