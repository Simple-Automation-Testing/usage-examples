...
function getSellerCompanyPageActions(decorators = [], preSetUp?: () => void, postSetUp?: () => void) {
...
getSellerCompanyPageActions.id = 'onSellerCompanyPage';

export { getSellerCompanyPageActions }
